 ...
 * Code example:
 * <code>
 * FormattedTableBuilder table = new FormattedTableBuilder();
 * table.addLine("Quantity","Description","Tax Code", "Amount");
 * table.addLine("3","Child Shoes - size 7","0","59.97");
 * table.addLine("2","Book - Assorted","1","22.00");
 * table.addNewLine();
 * table.addLine("","SUBTOTAL:","","241.93");
 * table.addLine("","0-HST:,"13%","28.59");
 * table.addLine("","TOTAL","","$271.62");
 * </code>
 * <p>
 * Output example:
 * <p>
...
public class FormattedTableBuilder {
    ...
    /**
     * Add {@param lineContent} into specified line of the table
     * @param position
     * @param lineContent
     */
    ...
    /**
     * Add {@param lineContent} to the bottom of the table
     *
     * @param lineContent
     */
     ...
     * <p>
     * To get the formatted string, use toString.
     *
